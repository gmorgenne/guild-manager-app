        ...
        <div>
            ...
            <div className="flex mb-8 justify-between border-b border-gray-200 dark:border-gray-700">
                ...
                <div ref={filterRef}>
                    ...
                    <div className={`fixed top-8 md:top-auto${filterClosed ? "" : " -translate-x-full"} left-full z-10 w-full max-w-4xl shadow-xl rounded-b-2xl bg-indigo-100 overflow-y-auto transition-transform duration-300 border-8 border-black shadow-left-xl dark:bg-gray-800`}>
